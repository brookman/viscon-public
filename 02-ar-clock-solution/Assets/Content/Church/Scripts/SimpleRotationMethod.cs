...
public class SimpleRotationMethod : MonoBehaviour, Clock.RotationMethod
{
    public Clock.HandRotation GetHandRotationForTime(TimeSpan timeSinceMidnight)
    {
        ...
        // Exercise:
        var rotationSeconds = minutesSinceMidnight % 60; // value 0.0 - 1.0
        var rotationMinutes = hoursSinceMidnight % 60; // value 0.0 - 1.0
        var rotationHours = hoursSinceMidnight / 12; // value 0.0 - 1.0
